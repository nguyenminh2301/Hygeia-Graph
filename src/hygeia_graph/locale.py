...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "app_title": {
        "en": "Hygeia-Graph: Medical Network Analysis",
        "vi": "Hygeia-Graph: Phân tích Mạng lưới Y tế",
    },
    "app_description": {
        "en": "Mixed Graphical Models, Temporal Dynamics, and Robustness Analysis",
        "vi": "Mô hình Đồ thị Hỗn hợp, Động lực Thời gian, và Phân tích Độ bền",
    },
    # Navigation
    "nav_home": {
        "en": "Home",
...
Kết quả nên được diễn giải bởi các nhà nghiên cứu có chuyên môn.""",
    ...
    # Introduction Page
    "intro_title": {
        "en": "Welcome to Hygeia-Graph",
        "vi": "Chào mừng đến với Hygeia-Graph",
    },
    "intro_subtitle": {
        "en": "Advanced Temporal & Network-based Analysis for Medical Data",
        "vi": "Phân tích Mạng lưới & Thời gian Nâng cao cho Dữ liệu Y tế",
    },
    "intro_description": {
        "en": """Hygeia-Graph facilitates **Mixed Graphical Modeling (MGM)** and advanced network analysis techniques 
for complex medical datasets. It integrates state-of-the-art methods like **Bootnet** (stability), **NCT** (comparison), 
and **LASSO** (feature selection) into a streamlined, interactive workflow.""",
        "vi": """Hygeia-Graph hỗ trợ **Mô hình hóa Đồ thị Hỗn hợp (MGM)** và các kỹ thuật phân tích mạng nâng cao 
cho dữ liệu y tế phức tạp. Nó tích hợp các phương pháp hiện đại như **Bootnet** (độ ổn định), **NCT** (so sánh), 
và **LASSO** (chọn đặc trưng) vào một quy trình làm việc tương tác, hợp lý hóa.""",
    },
    "core_features": {
        "en": "Core Features",
    ...
    "feat_mgm": {
        "en": "**MGM Analysis**: Model networks with mixed variable types (Gaussian, Categorical, Poisson).",
        "vi": "**Phân tích MGM**: Mô hình hóa mạng với các loại biến hỗn hợp (Gaussian, Phân loại, Poisson).",
    },
    "feat_temporal": {
        "en": "**Temporal Dynamics**: Analyze time-series relationships using Vector Autoregression (VAR).",
        "vi": "**Động lực thời gian**: Phân tích mối quan hệ chuỗi thời gian sử dụng Vector Autoregression (VAR).",
    },
    "feat_flow": {
        "en": "**Longitudinal Flow**: Track state transitions (T1 -> T2) with interactive Sankey diagrams.",
        "vi": "**Luồng dọc (Longitudinal)**: Theo dõi chuyển đổi trạng thái (T1 -> T2) với biểu đồ Sankey tương tác.",
    },
    "feat_robustness": {
        "en": "**Robustness (Bootnet)**: Assess network stability using non-parametric bootstrapping.",
        "vi": "**Độ bền (Bootnet)**: Đánh giá độ ổn định của mạng sử dụng bootstrap phi tham số.",
    },
    "feat_comparison": {
        "en": "**Comparison (NCT)**: Statistical comparison of network structure and global strength between groups.",
        "vi": "**So sánh (NCT)**: So sánh thống kê cấu trúc mạng và độ mạnh toàn cục giữa các nhóm.",
    },
    "feat_lasso": {
        "en": "**Feature Selection (LASSO)**: Preprocess high-dimensional data ensuring relevant variables.",
        "vi": "**Chọn đặc trưng (LASSO)**: Tiền xử lý dữ liệu nhiều chiều đảm bảo các biến liên quan.",
    },
    "start_guide": {
        "en": "Getting Started",
        "vi": "Bắt đầu",
    ...
    "nav_preprocess": {
        "en": "Preprocessing (LASSO)",
        "vi": "Tiền xử lý (LASSO)",
    },
    "nav_robustness": {
        "en": "Robustness (Bootnet)",
        "vi": "Độ bền (Bootnet)",
    },
    "nav_comparison": {
        "en": "Comparison (NCT)",
    ...
    "nav_simulation": {
        "en": "Intervention Simulation",
        "vi": "Mô phỏng Can thiệp",
    },
    "nav_publication": {
        "en": "Publication Pack",
        "vi": "Gói Xuất bản",
    ...
    "step_1_desc": {
        "en": "Upload your CSV/Excel file in 'Data & Schema'. Auto-infer variable types.",
        "vi": "Tải tệp CSV/Excel của bạn trong 'Tải dữ liệu & Schema'. Tự động suy luận loại biến.",
    },
    "step_2_title": {
        "en": "2. Configure Model",
        "vi": "2. Cấu hình Mô hình",
    },
    "step_2_desc": {
        "en": "Set regularization parameters (EBIC Gamma, Alpha) in 'Model Settings'.",
        "vi": "Thiết lập tham số chính quy hóa (EBIC Gamma, Alpha) trong 'Cài đặt Mô hình'.",
    },
    "step_3_title": {
        "en": "3. Run Analysis",
        "vi": "3. Chạy Phân tích",
    ...
    "step_3_desc": {
        "en": "Execute MGM estimation. Status and warnings will appear.",
        "vi": "Thực hiện ước lượng MGM. Trạng thái và cảnh báo sẽ xuất hiện.",
    },
    "step_4_title": {
        "en": "4. Explore & Export",
        "vi": "4. Khám phá & Xuất",
    ...
    "step_4_desc": {
        "en": "Visualize network, check centrality, and download results ZIP.",
        "vi": "Trực quan hóa mạng, kiểm tra độ trung tâm, và tải xuống ZIP kết quả.",
    },
}
